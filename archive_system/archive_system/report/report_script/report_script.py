...
def execute(filters=None):
	...
	# ], [
	# 	{
    #         'item_name': 'Application of Funds (Assets)',
    #         'trader_name': 'INR',
    #     },
    #     {
    #         'item_name': 'Current Assets - GTPL',
    #         'trader_name': 'INR',
    #     },
	# ]
	# return columns, data
...
def get_cs_data(filters):
	...
	data = frappe.get_all(
		doctype = 'Trader Item',
		fields = [
				'item_name','trader_name','pro_type','pro_country','price_type','rate','uom','uom_type','unique_number','price_type1','rate1','total2','total1'
				],
		filters = conditions,
